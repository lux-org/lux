...
class LuxDataFrame(pd.DataFrame):
    ...
    def set_intent_on_click(self, change):
        ...
        # self.output.append_display_data(self._widget)
        ...
        try:
            if self._pandas_only:
                ...
                self._toggle_pandas_display = (
                    self._default_pandas_display
                )  # Reset to Pandas Vis everytime
                ...
                if len(self.recommendation) > 0:
                    ...
                    def on_button_clicked(b):
                        ...
                        if self._toggle_pandas_display:
                            display(self.display_pandas())
                            # self.output.append_display_data(self.display_pandas())
                        else:
