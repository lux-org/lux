...
def test_underspecified_single_vis(test_show_more):
	...
	for attr in df.current_context[0]._inferred_intent: assert attr.data_model == "measure"
	for attr in df.current_context[0]._inferred_intent: assert attr.data_type == "quantitative"
