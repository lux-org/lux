...
def test_q1_performance_census():
	url = 'https://github.com/thyneb19/lux-datasets/blob/master/data/census.csv?raw=true'
	df = pd.read_csv(url)
	...
	assert delta < 3.8, "The recommendations on Census dataset took a total of {delta:0.4f} seconds, longer than expected."
